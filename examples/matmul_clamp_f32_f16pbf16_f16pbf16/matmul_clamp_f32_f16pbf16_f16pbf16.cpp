...
#include "kai_rhs_quant_pack_kxn_bf16p12x4biasf32_f16_neon.h"
...
void run_matmul_ref(
    size_t m, size_t n, size_t k, const Tin* lhs, const Tin* rhs, const float* bias, float* dst, float scalar_min,
    float scalar_max) {
...
int main() {
    ...
    const size_t N = 38;  // Columns of RHS and DST matrices, and length of the Bias vector.
    const size_t K = 47;  // Columns of LHS, rows of RHS matrices
    ...
    const size_t rhs_packed_size = kai_get_rhs_packed_size_rhs_quant_pack_kxn_bf16p12x4biasf32_f16_neon(N, K);
    ...
    kai_run_rhs_quant_pack_kxn_bf16p12x4biasf32_f16_neon(
    ...
    std::cout << "TEST[matmul_clamp_f32_f16pbf16_f16pbf16p]\n";
