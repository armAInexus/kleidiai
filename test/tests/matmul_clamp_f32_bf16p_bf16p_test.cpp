...
#include "kai/ukernels/matmul/matmul_clamp_f32_bf16p_bf16p/kai_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot.h"
...
const std::array gemm_methods = {
    MatMulMethod{
        ...
        .fn_get_sr = kai_get_sr_matmul_clamp_f32_bf16p_bf16p12x4b_8x12x4_neon_mmla,

        .fn_get_main_m_step = kai_get_m_step_matmul_clamp_f32_bf16p_bf16p12x4b_8x12x4_neon_mmla,
        .fn_get_pack_rhs_n_step = kai_get_n_step_rhs_quant_pack_kxn_bf16pbiasf32_f32_neon,
        .fn_get_main_n_step = kai_get_n_step_matmul_clamp_f32_bf16p_bf16p12x4b_8x12x4_neon_mmla,
        ...
        .fn_get_packed_lhs_offset = kai_get_lhs_packed_offset_matmul_clamp_f32_bf16p_bf16p12x4b_8x12x4_neon_mmla,
        ...
        .fn_get_main_packed_rhs_offset = kai_get_rhs_packed_offset_matmul_clamp_f32_bf16p_bf16p12x4b_8x12x4_neon_mmla,
...
const std::array gemv_methods = {
    MatMulMethod{
        ...
        .fn_get_mr = kai_get_mr_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_get_nr = kai_get_nr_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_get_kr = kai_get_kr_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_get_sr = kai_get_sr_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,

        .fn_get_main_m_step = kai_get_m_step_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_get_pack_rhs_n_step = kai_get_n_step_rhs_quant_pack_kxn_bf16pbiasf32_f32_neon,
        .fn_get_main_n_step = kai_get_n_step_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,

        .fn_get_lhs_offset = kai_get_lhs_offset_lhs_quant_pack_bf16p_f32_neon,
        .fn_get_packed_lhs_size = kai_get_lhs_packed_size_lhs_quant_pack_bf16p_f32_neon,
        .fn_get_packed_lhs_offset = kai_get_lhs_packed_offset_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_pack_lhs = kai_run_lhs_quant_pack_bf16p_f32_neon,
        ...
        .fn_get_packed_rhs_size_generic_block_size = kai_get_rhs_packed_size_rhs_quant_pack_kxn_bf16pbiasf32_f32_neon,
        .fn_get_pack_rhs_packed_rhs_offset = nullptr,
        .fn_get_main_packed_rhs_offset = kai_get_rhs_packed_offset_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_pack_rhs = kai_run_rhs_quant_pack_kxn_bf16pbiasf32_f32_neon,

        .fn_get_bias_offset = kai_get_bias_offset_rhs_quant_pack_kxn_bf16pbiasf32_f32_neon,

        .fn_get_dst_offset = kai_get_dst_offset_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
        .fn_get_dst_size = kai_get_dst_size_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,

        .fn_matmul_f32_bf16p_bf16p = kai_run_matmul_clamp_f32_bf16p_bf16p12x4b_1x36x4_neon_dot,
    },
    MatMulMethod{
