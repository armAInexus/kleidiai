...
///
/// -# kai_rhs_pack_kxn_f16p24x1biasf32_f16_f32_neon to pack the RHS matrix
...
size_t kai_get_m_step_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(void);
...
size_t kai_get_n_step_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(void);

/// Gets mr value.
///
/// This is the number of rows of output block size.
///
/// @return The mr value.
size_t kai_get_mr_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(void);
...
///
/// @return The nr value.
size_t kai_get_nr_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(void);
...
///
/// @return The kr value.
size_t kai_get_kr_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(void);
...
///
/// @return The sr value.
size_t kai_get_sr_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(void);
...
size_t kai_get_lhs_offset_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(size_t m_idx, size_t stride);
...
///
/// @return The offset in bytes to the data element.
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(size_t n_idx, size_t k);
...
///
/// @return The offset in bytes to the data element.
size_t kai_get_dst_offset_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(
...
size_t kai_get_dst_size_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(size_t m, size_t n);
...
///
///   * LHS: @ref kai_get_lhs_offset_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla.
///   * Packed RHS: @ref kai_get_rhs_packed_offset_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla.
///   * Output: @ref kai_get_dst_offset_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla.
///
...
void kai_run_matmul_clamp_f32_f32_bf16p4x1biasf32_4x24x4_neon_mmla(
