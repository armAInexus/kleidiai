...
#include "kai_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla.h"
...
size_t kai_get_m_step_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(void) {
    return kai_mr;
}

size_t kai_get_n_step_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(void) {
    return kai_nr;
}

size_t kai_get_mr_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(void) {
    return kai_mr;
}

size_t kai_get_nr_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(void) {
    return kai_nr;
}

size_t kai_get_kr_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(void) {
    return kai_kr;
}

size_t kai_get_sr_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(void) {
    return kai_sr;
}

size_t kai_get_lhs_offset_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(size_t m_idx, size_t stride) {
    KAI_ASSUME(m_idx % kai_mr == 0);

    return m_idx * stride;
}

size_t kai_get_rhs_packed_offset_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(size_t n_idx, size_t k) {
    KAI_ASSUME(n_idx % kai_nr == 0);

    return n_idx / kai_nr * (kai_nr * sizeof(float) + kai_nr * k * sizeof(bfloat16));
}

size_t kai_get_dst_offset_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(size_t m_idx, size_t n_idx, size_t stride) {
    KAI_ASSUME(m_idx % kai_mr == 0);
    KAI_ASSUME(n_idx % kai_nr == 0);
...
size_t kai_get_dst_size_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(size_t m, size_t n) {
    return m * n * sizeof(float);
}

void kai_run_matmul_clamp_bf16_bf16_f32p12x1biasf32_8x12x4_neon_mmla(
    size_t m, size_t n, size_t k, //
    const void* lhs_packed, size_t lhs_stride, //
    ...
    // ka.input_offset = lhs_stride / sizeof(bfloat16);
    ...
    __asm__ __volatile__(
      ...
      : [args_ptr] "r" (&ka), [ldc] "r" (ldc * sizeof(float)), [offset_max] "I" (offsetof(KernelArgs, maxval)), [offset_min] "I" (offsetof(KernelArgs, minval)), [offsetof_Bpanel] "I" (offsetof(KernelArgs, Bpanel)), [offsetof_K] "I" (offsetof(KernelArgs, K)), [offsetof_N] "I" (offsetof(KernelArgs, N))
