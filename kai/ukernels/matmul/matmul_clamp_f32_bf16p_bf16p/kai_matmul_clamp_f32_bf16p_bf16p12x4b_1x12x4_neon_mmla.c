...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_bf16p_bf16p12x4b_1x12x4_neon_mmla(size_t m_idx, size_t k) {
    KAI_ASSUME(m_idx == 0);
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_bf16p_bf16p12x4b_1x12x4_neon_mmla(size_t n_idx, size_t k) {
    KAI_ASSUME(n_idx % kai_get_n_step_matmul_clamp_f32_bf16p_bf16p12x4b_1x12x4_neon_mmla() == 0);
...
size_t kai_get_dst_offset_matmul_clamp_f32_bf16p_bf16p12x4b_1x12x4_neon_mmla(
    ...
    KAI_ASSUME(m_idx % kai_get_m_step_matmul_clamp_f32_bf16p_bf16p12x4b_1x12x4_neon_mmla() == 0);
    KAI_ASSUME(n_idx % kai_get_n_step_matmul_clamp_f32_bf16p_bf16p12x4b_1x12x4_neon_mmla() == 0);
