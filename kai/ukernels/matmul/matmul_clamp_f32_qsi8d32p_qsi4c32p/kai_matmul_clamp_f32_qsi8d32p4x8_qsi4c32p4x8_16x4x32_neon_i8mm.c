...
size_t kai_get_m_step_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(void) {
    return kai_m_step;
}

size_t kai_get_n_step_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(void) {
    return kai_n_step;
}

size_t kai_get_mr_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(void) {
    return kai_mr;
}

size_t kai_get_nr_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(void) {
    return kai_nr;
}

size_t kai_get_kr_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(void) {
    return kai_kr;
}

size_t kai_get_sr_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(void) {
    return kai_sr;
}

size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(
...
size_t kai_get_dst_offset_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(
...
size_t kai_get_dst_size_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(size_t m, size_t n) {
    return m * n * sizeof(float);
}

void kai_run_matmul_clamp_f32_qsi8d32p4x8_qsi4c32p4x8_16x4x32_neon_i8mm(
    ...
    size_t num_blocks = k / kai_block_size;
    ...
    __asm__ __volatile__(
        ...
        "mov x28, #0x88\n"
        "cmp x9, #0x10\n"
        "mul x28, %x[num_blocks], x28\n"
        "blt 9f\n"
        "1:"  // Row loop
        "mov x27, %x[rhs_packed]\n"
        "mov x26, %x[n]\n"
        "add x24, %x[dst], %x[dst_stride_row], LSL #4\n"
        "2:"  // Column loop
        ...
        "cmp x9, #0x10\n"
        "mov %x[dst], x24\n"
        "madd %x[lhs_packed], x20, x28, %x[lhs_packed]\n"
        "bge 1b\n"
        "9:"  // Row loop skip
        "cbz x9, 15f\n"
        "10:"  // Row tail: Row loop
        "mov x24, %x[rhs_packed]\n"
        "mov x23, %x[n]\n"
        "add x22, %x[dst], %x[dst_stride_row], LSL #2\n"
        "11:"  // Row tail: Column loop
        "movi v31.16b, #0x0\n"
        "movi v30.16b, #0x0\n"
        "mov x25, %x[lhs_packed]\n"
        ...
        : "cc", "memory", "v0", "v1", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v2", "v20",
          ...
          "v8", "v9", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28", "x9");
}
