...
size_t kai_get_n_step_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(void) {
    return kai_nr;
}

size_t kai_get_rhs_offset_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(size_t n_idx) {
    KAI_ASSUME(n_idx % kai_nr == 0);

    return n_idx * sizeof(uint16_t);
}

size_t kai_get_bias_offset_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(size_t n_idx) {
    return n_idx * sizeof(uint16_t);
}

size_t kai_get_rhs_packed_offset_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(size_t n_idx, size_t k) {
    KAI_ASSUME(n_idx % kai_nr == 0);

    return n_idx * (sizeof(uint16_t) + k * sizeof(uint16_t));
}

size_t kai_get_rhs_packed_size_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(size_t n, size_t k) {
    return kai_get_rhs_packed_offset_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(kai_roundup(n, kai_nr), k);
}

void kai_run_rhs_pack_kxn_f16p32x1biasf16_f16_f16_neon(
    ...
    __asm__ __volatile__(
        ...
        : "cc", "memory", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28",
          "v29", "v30", "v31", "x20", "x21", "x22", "x23", "x24", "x25");
}
