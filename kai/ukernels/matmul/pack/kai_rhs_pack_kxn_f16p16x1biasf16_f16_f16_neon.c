...
size_t kai_get_rhs_packed_size_rhs_pack_kxn_f16p16x1biasf16_f16_f16_neon(size_t n, size_t k) {
    return kai_get_rhs_packed_offset_rhs_pack_kxn_f16p16x1biasf16_f16_f16_neon(k, kai_roundup(n, kai_nr));
}
...
void kai_run_rhs_pack_kxn_f16p16x1biasf16_f16_f16_neon(
    ...
    __asm__ __volatile__(
        ...
        "bge 1b\n"
        "2:"  // Bias: Tail row loop start
        "cbz x22, 4f\n"
        "3:"  // Bias: Tail row loop body
        "ldr h20, [%x[bias], #0x0]\n"
        "sub x22, x22, #0x1\n"
        ...
        "bge 6b\n"
        "7:"  // Main row loop: Column loop skip
        "cbz x24, 12f\n"
        "cmp x24, #0x4\n"
        "movi v16.8h, #0x0\n"
        "str q16, [x23, #0x0]\n"
