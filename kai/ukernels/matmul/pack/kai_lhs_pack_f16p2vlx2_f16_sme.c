...
size_t kai_get_m_step_lhs_pack_f16p2vlx2_f16_sme(size_t mr) {
...
size_t kai_get_lhs_offset_lhs_pack_f16p2vlx2_f16_sme(size_t m_idx, size_t lhs_stride) {
    KAI_ASSUME(m_idx % (kai_mr * kai_get_sme_vector_length_u16()) == 0);

    return m_idx * lhs_stride;
}

size_t kai_get_lhs_packed_offset_lhs_pack_f16p2vlx2_f16_sme(size_t m_idx, size_t k, size_t mr, size_t kr, size_t sr) {
    const size_t scaled_mr = kai_mr * kai_get_sme_vector_length_u16();
...
size_t kai_get_lhs_packed_size_lhs_pack_f16p2vlx2_f16_sme(size_t m, size_t k, size_t mr, size_t kr, size_t sr) {
    KAI_ASSUME(mr == kai_mr * kai_get_sme_vector_length_u16());
    KAI_ASSUME(kr == kai_kr);
    KAI_ASSUME(sr == kai_sr);
    ...
    return kai_roundup(m, kai_mr * kai_get_sme_vector_length_u16()) * kai_roundup(k, kai_kr) * sizeof(__fp16);
}

void kai_run_lhs_pack_f16p2vlx2_f16_sme(
    ...
    const size_t block_height = kai_mr * kai_get_sme_vector_length_u16() / kai_kr;
    ...
    for (size_t block_y = 0; block_y < m; block_y += block_height) {
        ...
        void* out = lhs_packed + block_y * kai_roundup(k, kai_kr) * sizeof(__fp16);
