...
size_t kai_get_m_step_lhs_pack_x8p2vlx1_x8_sme(size_t mr) {
...
size_t kai_get_lhs_offset_lhs_pack_x8p2vlx1_x8_sme(size_t m_idx, size_t lhs_stride) {
    KAI_ASSUME(m_idx % (kai_mr * kai_get_sme_vector_length_u8()) == 0);

    return m_idx * lhs_stride;
}

size_t kai_get_lhs_packed_offset_lhs_pack_x8p2vlx1_x8_sme(size_t m_idx, size_t k, size_t mr, size_t kr, size_t sr) {
...
size_t kai_get_lhs_packed_size_lhs_pack_x8p2vlx1_x8_sme(size_t m, size_t k, size_t mr, size_t kr, size_t sr) {
    KAI_ASSUME(mr == kai_mr * kai_get_sme_vector_length_u8());
    KAI_ASSUME(kr == kai_kr);
    KAI_ASSUME(sr == kai_sr);
    ...
    return (kai_roundup(m, kai_mr * kai_get_sme_vector_length_u8()/kai_kr) * kai_roundup(k,kai_kr) * sizeof(int8_t));
}

void kai_run_lhs_pack_x8p2vlx1_x8_sme(
...
)
{
    ...
    const size_t block_height = (kai_mr * kai_get_sme_vector_length_u8()) / kai_kr;
    ...
    for (size_t block_y = 0; block_y < m; block_y += block_height) {
        ...
        void* out = lhs_packed + block_y * kai_roundup(k, kai_kr) * sizeof(int8_t);
