...
size_t kai_get_rhs_packed_size_rhs_quant_pack_kxn_bf16p12x4biasf32_f16_neon(size_t n, size_t k) {
    return kai_get_rhs_packed_offset_rhs_quant_pack_kxn_bf16p12x4biasf32_f16_neon(kai_roundup(n, kai_nr), k);
}
