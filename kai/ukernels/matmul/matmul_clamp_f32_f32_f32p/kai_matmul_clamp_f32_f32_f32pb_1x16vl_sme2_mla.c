...
#include "kai_matmul_clamp_f32_f32_f32pb_1x16vl_sme2_mla.h"
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_f32_f32pb_1x16vl_sme2_mla(size_t n_idx, size_t k) {
    KAI_ASSUME(n_idx % kai_get_n_step_matmul_clamp_f32_f32_f32pb_1x16vl_sme2_mla() == 0);
...
size_t kai_get_dst_offset_matmul_clamp_f32_f32_f32pb_1x16vl_sme2_mla(size_t m_idx, size_t n_idx, size_t dst_stride) {
    KAI_ASSUME(m_idx % kai_get_m_step_matmul_clamp_f32_f32_f32pb_1x16vl_sme2_mla() == 0);
    KAI_ASSUME(n_idx % kai_get_n_step_matmul_clamp_f32_f32_f32pb_1x16vl_sme2_mla() == 0);
