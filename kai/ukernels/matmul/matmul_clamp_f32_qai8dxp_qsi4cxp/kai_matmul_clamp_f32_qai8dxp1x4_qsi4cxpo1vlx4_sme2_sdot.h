...
size_t kai_get_m_step_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(void);
...
///
/// @return the n step
size_t kai_get_n_step_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(void);

/// Gets the mr value, which must be used to pack the LHS matrix with
/// the @ref kai_lhs_quant_pack_qai8dxp_f32 micro-kernel
///
/// @return the mr value
size_t kai_get_mr_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(void);
...
///
/// @return the nr value
size_t kai_get_nr_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(void);

/// Gets the kr value, which must be used to pack the RHS matrix with
/// the @ref kai_run_rhs_pack_nxk_qsi4cxpo_qsu4cxs1s0 micro-kernel
///
/// @return the kr value
size_t kai_get_kr_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(void);

/// Gets the sr value, which must be used to pack the RHS matrix with
/// the @ref kai_run_rhs_pack_nxk_qsi4cxpo_qsu4cxs1s0 micro-kernel
///
/// @return the sr value
size_t kai_get_sr_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(void);
...
size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(size_t m_idx, size_t k);
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(size_t n_idx, size_t k);
...
size_t kai_get_dst_offset_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(size_t m, size_t n);
...
void kai_run_matmul_clamp_f32_qai8dxp1x4_qsi4cxpo1vlx4_sme2_sdot(
