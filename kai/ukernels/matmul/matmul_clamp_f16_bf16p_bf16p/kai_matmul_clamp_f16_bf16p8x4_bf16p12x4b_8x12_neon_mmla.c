...
size_t kai_get_rhs_packed_offset_matmul_clamp_f16_bf16p8x4_bf16p12x4b_8x12_neon_mmla(size_t n_idx, size_t k) {
    ...
    return n_idx * (sizeof(__fp16) + kai_roundup(k, kai_kr) * sizeof(uint16_t));
}
...
void kai_run_matmul_clamp_f16_bf16p8x4_bf16p12x4b_8x12_neon_mmla(
    ...
    void* Cpanel = dst;
    size_t ldc = dst_stride_row / sizeof(__fp16);
    ...
    __asm__ __volatile__(
        ...
        : [args_ptr] "r"(&ka), [ldc] "r"(ldc * sizeof(__fp16)), [offset_max] "I"(offsetof(KernelArgs, maxval)),
